...
class FeatureTestBase(TestCaseBase):
    def __getFeaturesStrTuple(self, features):
        r = []
        for feat in features:
            r.append(str(feat))
            for childFld in ("features", "alignFeatures", "codingFeatures"):
                children = getattr(feat, childFld, None)
    ...
    def _assertFeatures(self, trans, expect):
        if debugResults:
            ...
            pprint.pprint(self.__getFeaturesStrTuple([trans]), width=1)
            print()
        self.assertEqual(self.__getFeaturesStrTuple([trans]), expect)
        ...
        self._assertFeatures(trans,
                             ('t=chr22:18900294-18905926/+, rna=AF010310.1:0-888/- 901',
                              ('exon 18900294-18900875 rna=13-618',
                               ('18900294-18900452 rna=13-171',
                                'None-None rna=171-174',
                                '18900452-18900453 rna=None-None',
                                '18900453-18900535 rna=174-256',
                                'None-None rna=256-257',
                                '18900535-18900565 rna=257-287',
                                'None-None rna=287-288',
                                '18900565-18900567 rna=288-290',
                                'None-None rna=290-291',
                                '18900567-18900577 rna=291-301',
                                'None-None rna=301-302',
                                '18900577-18900579 rna=302-304',
                                'None-None rna=304-305',
                                '18900579-18900606 rna=305-332',
                                'None-None rna=332-335',
                                '18900606-18900607 rna=None-None',
                                '18900607-18900611 rna=335-339',
                                'None-None rna=339-340',
                                '18900611-18900616 rna=340-345',
                                'None-None rna=345-346',
                                '18900616-18900621 rna=346-351',
                                'None-None rna=351-352',
                                '18900621-18900628 rna=352-359',
                                'None-None rna=359-369',
                                '18900628-18900634 rna=None-None',
                                '18900634-18900643 rna=369-378',
                                'None-None rna=378-379',
                                '18900643-18900645 rna=379-381',
                                'None-None rna=381-382',
                                '18900645-18900664 rna=382-401',
                                'None-None rna=401-402',
                                '18900664-18900669 rna=402-407',
                                'None-None rna=407-408',
                                '18900669-18900762 rna=408-501',
                                'None-None rna=501-502',
                                '18900762-18900790 rna=502-530',
                                'None-None rna=530-531',
                                '18900790-18900803 rna=531-544',
                                'None-None rna=544-545',
                                '18900803-18900871 rna=545-613',
                                'None-None rna=613-614',
                                '18900871-18900875 rna=614-618'),
                               'intron 18900875-18900950 rna=618-618 sjBases=CT...AC (spliceGT_AG)',
                               'exon 18900950-18901039 rna=618-707',
                               ('18900950-18901039 rna=618-707',),
                               'intron 18901039-18904402 rna=707-707 sjBases=CT...AC (spliceGT_AG)',
                               'exon 18904402-18904501 rna=707-806',
                               ('18904402-18904501 rna=707-806',),
                               'intron 18904501-18905828 rna=806-806 sjBases=CT...AC (spliceGT_AG)',
                               'exon 18905828-18905926 rna=806-901',
                               ('18905828-18905889 rna=806-867',
                                'None-None rna=867-868',
                                '18905889-18905893 rna=None-None',
                                '18905893-18905926 rna=868-901'))))
        ...
        self._assertFeatures(trans,
                             ('t=chr22:18893922-18899592/+, rna=X96484.1:48-1067/+ 1080',
                              ('exon 18893922-18893997 rna=48-123',
                               ('18893922-18893997 rna=48-123',),
                               'intron 18893997-18894077 rna=123-123 sjBases=GT...AG (spliceGT_AG)',
                               'exon 18894077-18894238 rna=123-285',
                               ('18894077-18894173 rna=123-219',
                                'None-None rna=219-220',
                                '18894173-18894238 rna=220-285'),
                               'intron 18894238-18897684 rna=285-285 sjBases=GT...AG (spliceGT_AG)',
                               'exon 18897684-18897785 rna=285-386',
                               ('18897684-18897785 rna=285-386',),
                               'intron 18897785-18898400 rna=386-386 sjBases=GT...AG (spliceGT_AG)',
                               'exon 18898400-18898541 rna=386-527',
                               ('18898400-18898541 rna=386-527',),
                               'intron 18898541-18899052 rna=527-527 sjBases=GT...AG (spliceGT_AG)',
                               'exon 18899052-18899592 rna=527-1067',
                               ('18899052-18899592 rna=527-1067',))))
        ...
        self._assertFeatures(rcTrans,
                             ('t=chr22:32398640-32404272/-, rna=AF010310.1:13-901/+ 901',
                              ('exon 32398640-32398738 rna=0-95',
                               ('32398640-32398673 rna=0-33',
                                '32398673-32398677 rna=None-None',
                                'None-None rna=33-34',
                                '32398677-32398738 rna=34-95'),
                               'intron 32398738-32400065 rna=95-95 sjBases=GT...AG (spliceGT_AG)',
                               'exon 32400065-32400164 rna=95-194',
                               ('32400065-32400164 rna=95-194',),
                               'intron 32400164-32403527 rna=194-194 sjBases=GT...AG (spliceGT_AG)',
                               'exon 32403527-32403616 rna=194-283',
                               ('32403527-32403616 rna=194-283',),
                               'intron 32403616-32403691 rna=283-283 sjBases=GT...AG (spliceGT_AG)',
                               'exon 32403691-32404272 rna=283-888',
                               ('32403691-32403695 rna=283-287',
                                'None-None rna=287-288',
                                '32403695-32403763 rna=288-356',
                                'None-None rna=356-357',
                                '32403763-32403776 rna=357-370',
                                'None-None rna=370-371',
                                '32403776-32403804 rna=371-399',
                                'None-None rna=399-400',
                                '32403804-32403897 rna=400-493',
                                'None-None rna=493-494',
                                '32403897-32403902 rna=494-499',
                                'None-None rna=499-500',
                                '32403902-32403921 rna=500-519',
                                'None-None rna=519-520',
                                '32403921-32403923 rna=520-522',
                                'None-None rna=522-523',
                                '32403923-32403932 rna=523-532',
                                '32403932-32403938 rna=None-None',
                                'None-None rna=532-542',
                                '32403938-32403945 rna=542-549',
                                'None-None rna=549-550',
                                '32403945-32403950 rna=550-555',
                                'None-None rna=555-556',
                                '32403950-32403955 rna=556-561',
                                'None-None rna=561-562',
                                '32403955-32403959 rna=562-566',
                                '32403959-32403960 rna=None-None',
                                'None-None rna=566-569',
                                '32403960-32403987 rna=569-596',
                                'None-None rna=596-597',
                                '32403987-32403989 rna=597-599',
                                'None-None rna=599-600',
                                '32403989-32403999 rna=600-610',
                                'None-None rna=610-611',
                                '32403999-32404001 rna=611-613',
                                'None-None rna=613-614',
                                '32404001-32404031 rna=614-644',
                                'None-None rna=644-645',
                                '32404031-32404113 rna=645-727',
                                '32404113-32404114 rna=None-None',
                                'None-None rna=727-730',
                                '32404114-32404272 rna=730-888'))))
